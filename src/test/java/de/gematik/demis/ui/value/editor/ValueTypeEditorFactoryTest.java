...
class ValueTypeEditorFactoryTest {
  ...
  void createEditor() {
    Assert.assertEquals(
        BooleanEditor.class, ValueTypeEditorFactory.createEditor(VALUE_TYPE.BOOLEAN).getClass());
    Assert.assertEquals(
        IntEditor.class, ValueTypeEditorFactory.createEditor(VALUE_TYPE.INT).getClass());
    Assert.assertEquals(
        PortEditor.class, ValueTypeEditorFactory.createEditor(VALUE_TYPE.PORT).getClass());
    Assert.assertEquals(
    ...
    Assert.assertEquals(
        PasswordEditor.class, ValueTypeEditorFactory.createEditor(VALUE_TYPE.PASSWORD).getClass());
    Assert.assertEquals(
        RelativPathListEditor.class,
        ValueTypeEditorFactory.createEditor(VALUE_TYPE.PATH_LIST).getClass());
  }
